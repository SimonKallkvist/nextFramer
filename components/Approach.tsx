    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4 ">
        <Card
          ...
          description="We'll collaborate to map out your website's goals, target audience, and key functionalites.  We'll discuss things like structure, navigation and content requirements"
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
